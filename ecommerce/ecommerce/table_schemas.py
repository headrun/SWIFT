...
CREATE TABLE `products_info` (
  ...
  `web_id` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  ...
  `category` varchar(512) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `sub_category` varchar(512) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `brand` varchar(512) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
