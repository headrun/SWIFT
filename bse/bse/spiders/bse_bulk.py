...
class Bse(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        headers = {
            ...
            'referer': 'https://www.bseindia.com/stock-share-price/reliance-industries-ltd/reliance/500325/bulk-block-deals/',
        ...
        for code in scrip_code:
            ...
            url = 'https://api.bseindia.com/BseIndiaAPI/api/BulkblockDeal/w?'+urlencode(params)
    ...
    def parse(self, response):
        ...
        for row in res['Table']:
            ...
            query  = "insert ignore into  bulk_deals ({0}) values {1}".format(','.join(column_names), tuple(values_))
