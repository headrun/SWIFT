...
class Bse(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        for code in scrip_code:
            ...
            url = 'https://api.bseindia.com/BseIndiaAPI/api/InsiderTrade15/w?'+urlencode(params)
    ...
    def parse(self, response):
        ...
        resp.to_sql('insider_2015', con = engine, if_exists = 'replace', chunksize = 1000, index=False)