...
class Bse(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        headers = {
            ...
            'referer': 'https://www.bseindia.com/stock-share-price/reliance-industries-ltd/reliance/500325/debt-most-active-series/',
        ...
        for code in scrip_code:
            ...
            url = 'https://api.bseindia.com/BseIndiaAPI/api/DebActiveDebtSeries/w?'+urlencode(params)
    ...
    def parse(self, response):
        ...
        resp.rename(columns = {'Change':'Change_'}, inplace=True)
        ...
        resp.to_sql('debt', con = engine, if_exists = 'replace', chunksize = 1000, index=False)
