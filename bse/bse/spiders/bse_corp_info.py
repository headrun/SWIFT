...
class Bse(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        headers = {
            ...
            'referer': 'https://www.bseindia.com/stock-share-price/reliance-industries-ltd/reliance/500325/corp-information/',
        ...
        for code in scrip_code:
            ...
            url = 'https://api.bseindia.com/BseIndiaAPI/api/CorpInfoNew/w?'+urlencode(params)
    ...
    def parse(self, response):
        ...
        resp.to_sql('corp_info', con = engine, if_exists = 'replace', chunksize = 1000, index=False)