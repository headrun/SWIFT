...
class SportsdbSetup:
    ...
    def create_new_record(self):
        ...
        if tid and (len(pt_ids) == 2 or self.participant_type == 'player') or \
            ...
            game_values = (self.source_key, self.game_datetime, self.sport_id, rd[0], tid, self.game_status, rd[1], rd[2], rd[3], ref_url, event_id, loc_id, std_id, self.time_unknown, self.tz_info)
    ...
    def update_record(self):
        ...
        if self.game_status == "scheduled" and self.game_status == "closed":
