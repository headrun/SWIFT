    ...
    def parse(self, response):
        ...
        for rd_data in data:
            ...
            if parent_id:
                    ...
                    yield Request(ref_url.replace('https', 'http'), callback=self.parse_next, meta = {'start_date': start_date, 'end_date': end_date, 'proxy':'http://internal-sports-api-proxy-prod-0-1192592570.us-east-1.elb.amazonaws.com:8080/'}, headers = {"X-SPORTSAPI-EXT-PROXY-CLIENT": "Sports_KG"})
