        ...
        for node in sport_nodes:
            ...
            for movie in movie_nodes:
                ...
                if not movie_link:
                    ...
                    yield Request(movie_link.replace('https', 'http'), callback= self.parse_wiki, meta={'sp_nm': sport_name, 'mv_titl': movie_titl, 'mv_year': movie_year, 'mv_gnr': movie_genre, 'mv_note': movie_note, 'proxy':'http://internal-sports-api-proxy-prod-0-1192592570.us-east-1.elb.amazonaws.com:8080/'}, headers = {"X-SPORTSAPI-EXT-PROXY-CLIENT": "Sports_KG"})
