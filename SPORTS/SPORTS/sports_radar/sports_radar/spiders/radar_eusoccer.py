...
class EUSoccer:
    ...
    def player_details(self):
        ...
        for record in records:
            ...
            if not birth_date:
                continue
            query = 'select sp.id from sports_participants sp, sports_players pl where sport_id="7" and gid like %s and sp.id=pl.participant_id and title =%s and birth_date=%s'
            gid = '%' + 'PL' + '%'
