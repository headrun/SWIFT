...
PL_NAME_QUERY = 'select P.id from sports_participants P, sports_players PL where P.title=%s and P.sport_id="4" and P.id=PL.participant_id and PL.birth_date=%s'
PL_AKA_QUERY = 'select P.id from sports_participants P, sports_players PL where P.aka=%s and P.sport_id="4" and P.id=PL.participant_id and PL.birth_date=%s'
        ...
        for conference in conferences:
            ...
            for division in divisions:
                ...
                for team in teams:
                    ...
                    yield Request(req_url.replace('https', 'http'), self.parse_next, meta={'proxy':'http://internal-sports-api-proxy-prod-0-1192592570.us-east-1.elb.amazonaws.com:8080/'}, headers = {"X-SPORTSAPI-EXT-PROXY-CLIENT": "Sports_KG"})
