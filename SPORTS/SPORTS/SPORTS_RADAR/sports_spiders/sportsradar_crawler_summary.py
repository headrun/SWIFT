...
JINJA_FILE_NAME   = 'sportsradar_crawler_summary.jinja'
HTML_FILE_NAME    = 'sportsradar_crawler_summary.html'
...
class Report(VtvTask):
    ...
    def set_options(self):
        config_file_name = os.path.join(self.system_dirs.VTV_ETC_DIR, 'sportsradar_crawler_summary.cfg')
