...
################################################################################
#$Id: datagen_summary.py,v 1.1 2017/01/04 12:09:29 headrun Exp $
...
JINJA_FILE_NAME   = 'datagen_summary.jinja'
HTML_FILE_NAME    = 'datagen_summary.html'
...
class Report(VtvTask):
    ...
    def set_options(self):
        config_file_name = os.path.join(self.system_dirs.VTV_ETC_DIR, 'sports_datagen_summary.cfg')
