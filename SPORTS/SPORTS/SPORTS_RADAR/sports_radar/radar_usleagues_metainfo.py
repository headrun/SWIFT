...
INT_PL = 'insert into sports_players_bkp(id, title, sport_id, first_name, last_name, abbr_name, reference_url, debut, main_role, roles, height, weight, birth_date, birth_place, college, high_school, experience, salary, updated, created_at, modified_at) values (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s,%s, %s, %s, %s, %s,%s, %s, %s, %s, now(), now()) on duplicate key update modified_at = now(), debut=%s, sport_id=%s' 
        ...
        for conf in conference:
            ...
            for div in division:
                ...
                for team in teams:
                    ...
                    yield Request(team_url, callback=self.parse_teams, meta = {'tou_id': id_, 'sport_id': sport_id})
