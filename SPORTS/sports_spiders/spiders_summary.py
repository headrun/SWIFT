...
STATS_DIR_LIST = [
    ( 'MlbRoster',              '10.28.216.45', 'MlbRoster_',                'MlbRoster',                 'D', 'MLB ROSTER'),
    ( 'MLBSpiderSchedules',     '10.28.216.45', 'MLBSpiderSchedules_',       'MLBSpiderSchedules',        'D', 'MLB SPIDER SCHEDULES'),
    ( 'MLBSpiderScores',        '10.28.216.45', 'MLBSpiderScores_',          'MLBSpiderScores',           'D', 'MLB SPIDER SCORES'),
    ( 'MLBStandings',           '10.28.216.45', 'MLBStandings_',             'MLBStandings',              'D', 'MLB STANDINGS'),
    ( 'MexicanBaseballSchedules', '10.28.216.45', 'MexicanBaseballSchedules_', 'MexicanBaseballSchedules', 'D', 'MEXICAN BASEBALL SCHEDULES'),
    ( 'MexicanBaseballScores', '10.28.216.45', 'MexicanBaseballScores_', 'MexicanBaseballScores',          'D', 'MEXICAN BASEBALL SCORES'),
    ( 'MexBaseballStandings',   '10.28.216.45', 'MexBaseballStandings_',     'MexBaseballStandings',      'D', 'MEX BASEBALL STANDINGS'),
    ( 'MexBaseballRoster',      '10.28.216.45', 'MexBaseballRoster_',        'MexBaseballRoster',         'D', 'MEX BASEBALL ROSTER'),

    ( 'NbaRoster',              '10.28.216.45', 'NbaRoster_',                'NbaRoster',                 'D', 'NBA ROSTER'),
    ( 'NBASpiderSchedules',     '10.28.216.45', 'NBASpiderSchedules_',       'NBASpiderSchedules',        'D', 'NBA SPIDER SCHEDULES'),
    ( 'NBASpiderScores',        '10.28.216.45', 'NBASpiderScores_',          'NBASpiderScores',           'D', 'NBA SPIDER SCORES'),
    ( 'NBAStandings',           '10.28.216.45', 'NBAStandings_',             'NBAStandings',              'D', 'NBA STANDINGS'),
    ( 'EuroNBASchedules',       '10.28.216.45', 'EuroNBASchedules_',         'EuroNBASchedules',           'D', 'EURO BASKETBALL SCHEDULES'),
    ( 'EuroNBAScores',          '10.28.216.45', 'EuroNBAScores_',            'EuroNBAScores',              'D', 'EURO BASKETBALL SCORES'),
    ( 'BasketfiSpiderSchedules','10.28.216.45', 'BasketfiSpiderSchedules_',  'BasketfiSpiderSchedules',    'D', 'FINLAND BASKETBALL SCHEDULES'),
    ( 'BasketfiSpiderScores',   '10.28.216.45', 'BasketfiSpiderScores_',     'BasketfiSpiderScores',       'D', 'FINLAND BASKETBALL SCORES'),
    ( 'ScandbasketballStandings', '10.28.216.45', 'ScandbasketballStandings_', 'ScandbasketballStandings', 'D', 'SCAND BASKETBALL STANDINGS'),
    ( 'BasketballRealgmScores', '10.28.216.45', 'BasketballRealgmScores_',   'BasketballRealgmScores',    'D', 'BASKETBALL REALGM SCORES'),
    ( 'BasketballRealgmSchedules', '10.28.216.45', 'BasketballRealgmSchedules_', 'BasketballRealgmSchedules', 'D', 'BASKETBALL REALGM SCHEDULES'),
    ( 'BasketballRealgmRoster',  '10.28.216.45', 'BasketballRealgmRoster_',  'BasketballRealgmRoster',    'D', 'BASKETBALL REALGM ROSTER'),
    ( 'CBABasketballScores',     '10.28.216.45', 'CBABasketballScores_',     'CBABasketballScores',       'D', 'CBA BASKETBALL SCORES'),
    ( 'CBABasketballSchedules',  '10.28.216.45', 'CBABasketballSchedules_',  'CBABasketballSchedules',    'D', 'CBA BASKETBALL SCHEDULES'),
    ( 'CBAStandings',            '10.28.216.45', 'CBAStandings_',            'CBAStandings',              'D', 'CBA STANDINGS'),

    ( 'NhlRosterNEW',           '10.28.216.45', 'NhlRosterNEW_',             'NhlRosterNEW',              'D', 'NHL ROSTER'),
    ( 'NHLSpiderSchedules',     '10.28.216.45', 'NHLSpiderSchedules_',       'NHLSpiderSchedules',        'D', 'NHL SPIDER SCHEDULES'),
    ( 'NHLSpiderScores',        '10.28.216.45', 'NHLSpiderScores_',          'NHLSpiderScores',           'D', 'NHL SPIDER SCORES'),
    ( 'NHL_Standings',          '10.28.216.45', 'NHL_Standings_',            'NHL_Standings',             'D', 'NHL STANDINGS'),
    ( 'NHLESPNSpiderScores',    '10.28.216.45', 'NHLESPNSpiderScores_',      'NHLESPNSpiderScores',       'D', 'NHL ESPN SPIDER SCORES'),
    ( 'NHLESPNSpiderSchedules',    '10.28.216.45', 'NHLESPNSpiderSchedules_',      'NHLESPNSpiderSchedules',       'D', 'NHL ESPN SPIDER SCHEDULES'),
    ( 'ESPNNHLStandings',       '10.28.216.45',   'ESPNNHLStandings_',       'ESPNNHLStandings',          'D', 'ESPN NHL STANDINGS'),
    ( 'HockeyChampTrophy',      '10.28.216.45', 'HockeyChampTrophy_',        'HockeyChampTrophy',         'D', 'HOCKEY CHAMP TROPHY'),
    ( 'ChampTrophyStandings',   '10.28.216.45', 'ChampTrophyStandings_',     'ChampTrophyStandings',      'D', 'CHAMP TROPHY STANDINGS'),
    ( 'NCAAHockeySchedules',   '10.28.216.45',  'NCAAHockeySchedules_',      'NCAAHockeySchedules',       'D', 'NCAA HOCKEY SCHEDULES'),
    ( 'NCAAHockeyScores',      '10.28.216.45',  'NCAAHockeyScores_',         'NCAAHockeyScores',          'D', 'NCAA HOCKEY SCORES'),
    ( 'KhlStandings',          '10.28.216.45',  'KhlStandings_',             'KhlStandings',              'D', 'KHL STANDINGS'),
    ( 'KHLSpiderSchedules',    '10.28.216.45',  'KHLSpiderSchedules_',       'KHLSpiderSchedules',        'D', 'KHL SCHEDULES'),
    ( 'KHLSpiderScores',       '10.28.216.45',  'KHLSpiderScores_'   ,       'KHLSpiderScores',           'D', 'KHL SCORES'),
    ( 'FIHHockeyScores',       '10.28.216.45',  'FIHHockeyScores_',          'FIHHockeyScores',           'D', 'FIH HOCKEY SCORES'),
    ( 'FIHHockeySchedues',     '10.28.216.45',  'FIHHockeySchedues_',        'FIHHockeySchedues',         'D', 'FIH HOCKEY SCHEDULES'),
    ( 'FIHStandings',          '10.28.216.45',  'FIHStandings_',             'FIHStandings',              'D', 'FIH STANDINGS'),

    ( 'NflRoster',              '10.28.216.45', 'NflRoster_',                'NflRoster',                 'D', 'NFL ROSTER'),
    ( 'NFLSpiderSchedules',     '10.28.216.45', 'NFLSpiderSchedules_',       'NFLSpiderSchedules',        'D', 'NFL SPIDER SCHEDULES'),
    ( 'NFLESPNSpiderScores',    '10.28.216.45', 'NFLESPNSpiderScores_',      'NFLESPNSpiderScores',       'D', 'NFL SPIDER SCORES'),
    ( 'NFLESPNSpiderSchedules', '10.28.216.45', 'NFLESPNSpiderSchedules_',   'NFLESPNSpiderSchedules',    'D', 'NFL SPIDER SCHEDULES'),

    ( 'RosterCheck',            '10.28.216.45', 'RosterCheck_',              'RosterCheck',               'D', 'ROSTER CHECK'),
    ( 'CricketRosterCheck',     '10.28.216.45', 'CricketRosterCheck_',       'CricketRosterCheck',        'D', 'CRICKET ROSTER CHECK'),

    ( 'RulesFootballSchedules', '10.28.216.45', 'RulesFootballSchedules_',   'RulesFootballSchedules',    'D', 'AFL SCHEDULES'),
    ( 'RulesFootballScores',    '10.28.216.45', 'RulesFootballScores_',      'RulesFootballScores',       'D', 'AFL SCORES'),
    ( 'AflStandings',           '10.28.216.45', 'AflStandings_',             'AflStandings',              'D', 'AFL STANDINGS'),

    ( 'CFLSpider',              '10.28.216.45', 'CFLSpider_',                'CFLSpider',                 'D', 'CFL SPIDER'),
    ( 'CFLStandings',           '10.28.216.45', 'CFLStandings_',             'CFLStandings',              'D', 'CFL STANDINGS'),
    ( 'CFLRoster',              '10.28.216.45', 'CFLRoster_',                'CFLRoster',                 'D', 'CFL ROSTER'),

    ( 'NFLSpiderScores',        '10.28.216.45', 'NFLSpiderScores_',          'NFLSpiderScores',           'D', 'NFL SPIDER SCORES'),
    ( 'NFL_Standings',          '10.28.216.45', 'NFL_Standings_',            'NFL_Standings',             'D', 'NFL STANDINGS'),

    ( 'WnbaRoster',             '10.28.216.45', 'WnbaRoster_',               'WnbaRoster',                'D', 'WNBA ROSTER'),
    ( 'WnbaSpiderSchedules',    '10.28.216.45', 'WnbaSpiderSchedules_',      'WnbaSpiderSchedules',       'D', 'WNBA SPIDER SCHEDULES'),
    ( 'WnbaSpiderScores',       '10.28.216.45', 'WnbaSpiderScores_',         'WnbaSpiderScores',          'D', 'WNBA SPIDER SCORES'),
    ( 'WNBAStandings',          '10.28.216.45', 'WNBAStandings_',            'WNBAStandings',             'D', 'WNBA STANDINGS'),

    ( 'TennisSpiderSchedules',  '10.28.216.45', 'TennisSpiderSchedules_',    'TennisSpiderSchedules',     'D', 'TENNIS SPIDER SCHEDULES'),
    ( 'TennisSpiderScores',     '10.28.216.45', 'TennisSpiderScores_',       'TennisSpiderScores',        'D', 'TENNIS SPIDER SCORES'),
    ( 'Wimbledon',              '10.28.216.45', 'Wimbledon_',                'Wimbledon',                 'D', 'WIMBLEDON GAMES'),
    ( 'FrenchOpenSchedules',    '10.28.216.45', 'FrenchOpenSchedules_',      'FrenchOpenSchedules',       'D', 'FRENCH OPEN SCHEDULES'),
    ( 'FrenchOpenDraws',        '10.28.216.45', 'FrenchOpenDraws_',          'FrenchOpenDraws',           'D', 'FRENCH OPEN DRAWS'),
    ( 'FrenchOpenQualifying',   '10.28.216.45', 'FrenchOpenQualifying_',     'FrenchOpenQualifying',      'D', 'FRENCH OPEN QUALIIFYING'),
    ( 'UsopenTennis',           '10.28.216.45', 'UsopenTennis_',             'UsopenTennis',              'D', 'US OPEN TENNIS'),
    ( 'TennisFedCup',           '10.28.216.45', 'TennisFedCup_',             'TennisFedCup',              'D', 'TENNIS FED CUP'),
    ( 'IPTLTennis',             '10.28.216.45', 'IPTLTennis_',               'IPTLTennis',                'D', 'IPTL TENNIS'),
    ( 'IPTLStandings',          '10.28.216.45', 'IPTLStandings_',            'IPTLStandings',             'D', 'IPTL STANDINGS'),
    ( 'WorldTourTennisScores',  '10.28.216.45', 'WorldTourTennisScores_',    'WorldTourTennisScores',     'D', 'WORLD TOUR TENNIS SCORES'),
    ( 'WorldTourTennisSchedules', '10.28.216.45', 'WorldTourTennisSchedules_', 'WorldTourTennisSchedules', 'D', 'WORLD TOUR TENNIS SCHEDULES'),
    ( 'DavisCupSpider',         '10.28.216.45',  'DavisCupSpider_',          'DavisCupSpider',            'D',  'DAVIS CUP SPIDER'),
    ( 'DaviscupRoster',         '10.28.216.45',  'DaviscupRoster_',          'DaviscupRoster',            'D',  'DAVIS CUP ROSTER'),
    ( 'FedcupRoster',           '10.28.216.45',  'FedcupRoster_',            'FedcupRoster',              'D',  'FED CUP ROSTER'),
    ( 'HopmancupRoster',        '10.28.216.45',  'HopmancupRoster_',         'HopmancupRoster',           'D',  'HOPMAN CUP ROSTER'),
    ( 'HopmanCupSchedules',     '10.28.216.45',  'HopmanCupSchedules_',      'HopmanCupSchedules',        'D',  'HOPMAN CUP SCHEDULES'),
    ( 'HopmanCupScores',        '10.28.216.45',  'HopmanCupScores_',         'HopmanCupScores',           'D',   'HOPMAN CUP SCORES'),
    ( 'AtpWtaStandings',        '10.28.216.45',  'AtpWtaStandings_',         'AtpWtaStandings',           'D',   'ATP WTA STANDINGS'),
    ( 'USOpenTennisSeed',       '10.28.216.45',  'USOpenTennisSeed_',        'USOpenTennisSeed',          'D',  'US OPEN TENNIS SEED'),

    ( 'PGATourSchedules',       '10.28.216.45', 'PGATourSchedules_',         'PGATourSchedules',          'D', 'PGA TOUR SCHEDULES'),
    ( 'PGATourOngoing',         '10.28.216.45', 'PGATourOngoing_',           'PGATourOngoing',            'D', 'PGA TOUR ONGOING'),
    ( 'PGATourScores',          '10.28.216.45', 'PGATourScores_',            'PGATourScores',             'D', 'PGA TOUR SOCRES'),
    ( 'PGAStandings',           '10.28.216.45', 'PGAStandings_',             'PGAStandings',              'D', 'PGA STANDINGS'),
    ( 'LPGAGames',              '10.28.216.45', 'LPGAGames_',                'LPGAGames',                 'D', 'LPGA GAMES'),
    ( 'LPGAOngoing',            '10.28.216.45', 'LPGAOngoing_',              'LPGAOngoing',               'D', 'LPGA ONGOING'),
    ( 'LPGAStandings',          '10.28.216.45', 'LPGAStandings_',            'LPGAStandings',             'D', 'LPGA STANDINGS'),
    ( 'EuropeanTourSchedules',  '10.28.216.45', 'EuropeanTourSchedules_',    'EuropeanTourSchedules',     'D', 'EUROPEAN TOUR Schedules'),
    ( 'EuropeanTourOngoing',    '10.28.216.45', 'EuropeanTourOngoing_',      'EuropeanTourOngoing',       'D', 'EUROPEAN TOUR ONGOING'),
    ( 'EuropeanTourScores',     '10.28.216.45', 'EuropeanTourScores_',       'EuropeanTourScores',        'D', 'EUROPEAN TOUR SCORES'),
    ( 'PGAEuropeanStandings',   '10.28.216.45', 'PGAEuropeanStandings_',     'PGAEuropeanStandings',      'D', 'EUROPEAN STANDINGS'),
    ( 'ChampionsUsopenSpider',  '10.28.216.45', 'ChampionsUsopenSpider_',    'ChampionsUsopenSpider',     'D', 'CHAMPIONS US OPEN SPIDER'),
    ( 'ChampionsTour',          '10.28.216.45', 'ChampionsTour_',            'ChampionsTour',             'D', 'CHAMPIONS TOUR'),
    ( 'ChampionsOngoing',       '10.28.216.45', 'ChampionsOngoing_',         'ChampionsOngoing',          'D', 'CHAMPIONS ONGOING'),
    ( 'WebcomTour',             '10.28.216.45', 'WebcomTour_',               'WebcomTour',                'D', 'WEBCOM TOUR GAMES'),
    ( 'WebcomOngoing',          '10.28.216.45', 'WebcomOngoing_',            'WebcomOngoing',             'D', 'WEBCOM ONGOING'),
    ( 'SeniorTour',             '10.28.216.45', 'SeniorTour_',               'SeniorTour',                'D', 'SENIOR TOUR'),
    ( 'GolfSeniorTourScores',   '10.28.216.45', 'GolfSeniorTourScores_',     'GolfSeniorTourScores',      'D', 'GOLF SENIOR TOUR SCORES'),
    ( 'GolfSeniorTourSchedules', '10.28.216.45', 'GolfSeniorTourSchedules_', 'GolfSeniorTourSchedules',   'D', 'GOLF SENIOR TOUR SCHEDULES'),
    ( 'RyderCup',               '10.28.216.45',  'RyderCup_',                'RyderCup',                   'D', 'RYDERCUP'),
    ( 'AustraliaOpenGolf',      '10.28.216.45',  'AustraliaOpenGolf_',       'AustraliaOpenGolf',         'D', 'AUSTRALIA OPEN GOLF'),

    ( 'IccCricket',             '10.28.216.45', 'IccCricket_',               'IccCricket',                'D', 'ICC CRICKET'),
    ( 'CricketStandings',       '10.28.216.45', 'CricketStandings_',         'CricketStandings',          'D', 'CRICKET STANDINGS'),
    ( 'IPLStandings',           '10.28.216.45', 'IPLStandings_',             'IPLStandings',              'D', 'IPL STANDINGS'),
    ( 'IPLCricketRoster',       '10.28.216.45', 'IPLCricketRoster_',         'IPLCricketRoster',          'D',  'IPL CRICKET ROSTER'),
    ( 'ICCIntCupStandings',      '10.28.216.45', 'ICCIntCupStandings_',      'ICCIntCupStandings',        'D', 'ICC INTCUP STANDINGS'),
    ( 'ICCWorldCupStandings',   '10.28.216.45', 'ICCWorldCupStandings_',     'ICCWorldCupStandings',      'D', 'ICC WORLD CUP STANDINGS'),
    ( 'WCLCricketStandings',    '10.28.216.45', 'WCLCricketStandings_',      'WCLCricketStandings',       'D', 'WCL CRICKET STANDINGS'),
    ( 'CountyCricketStandings',  '10.28.216.45', 'CountyCricketStandings_',   'CountyCricketStandings',    'D',  'COUNTY CRICKET STANDINGS'),
    ( 'NatWestCricketStandings', '10.28.216.45', 'NatWestCricketStandings_',  'NatWestCricketStandings',   'D',  'NATWEST CRICKET STANDINGS'),
    ( 'CPLStandings',            '10.28.216.45', 'CPLStandings_',             'CPLStandings',              'D',  'CPL STANDINGS'),
    ( 'ICCInterCupRosters',       '10.28.216.45', 'ICCInterCupRosters_',      'ICCInterCupRosters',         'D',  'ICC INTER CUP ROSTERS'),
    ( 'WCLCricketRosters',       '10.28.216.45',  'WCLCricketRosters_',       'WCLCricketRosters',         'D', 'WCL CRICKET ROSTERS'),
    ( 'RoyalOneDayCupStandings',  '10.28.216.45', 'RoyalOneDayCupStandings_', 'RoyalOneDayCupStandings',   'D', 'ROYAL ONE DAY CUP STANDINGS'),
    ( 'CountyCricketRoster',     '10.28.216.45',  'CountyCricketRoster_',     'CountyCricketRoster',       'D', 'COUNTY CRICKET ROSTER'),
    ( 'HKPLStandings',           '10.28.216.45',  'HKPLStandings_',           'HKPLStandings',             'D', 'HKPL STANDINGS'),
    ( 'BigbashStandings',        '10.28.216.45',  'BigbashStandings_',        'BigbashStandings',          'D', 'BIG BASH STANDINGS'),


    ( 'UefaMajorLegauesScores', '10.28.216.45', 'UefaMajorLegauesScores_',   'UefaMajorLegauesScores',    'D', 'UEFA MAJOR LEAGUE SCORES'),
    ( 'UEFALeaguesRoster',      '10.28.216.45', 'UEFALeaguesRoster_',        'UEFALeaguesRoster',         'D', 'UEFA LEAGUES ROSTER'),
    ( 'UefaLeaguesSchedules',   '10.28.216.45', 'UefaLeaguesSchedules_',     'UefaLeaguesSchedules',      'D', 'UEFA LEAGUE SCHEDULES'),
    ( 'UefaLeaguesScores',      '10.28.216.45', 'UefaLeaguesScores_',        'UefaLeaguesScores',         'D', 'UEFA LEAGUE SCORES'),
    ( 'UEFALeaguesStandings',   '10.28.216.45', 'UEFALeaguesStandings_',     'UEFALeaguesStandings',      'D', 'UEFA LEAGUES STANDINGS'),
    ( 'UefaCupsScores',         '10.28.216.45', 'UefaCupsScores_',           'UefaCupsScores',            'D', 'UEFA CUPS SCORES'),
    ( 'UefaCupsSchedules',      '10.28.216.45', 'UefaCupsSchedules_',        'UefaCupsSchedules',         'D', 'UEFA CUPS SCHEDULES'),
    ( 'UefaAssociationLeaguesSchedules', '10.28.216.45', 'UefaAssociationLeaguesSchedules_', 'UefaAssociationLeaguesSchedules', 'D', 'UEFA ASSOC LEAGUE SCHEDULES'),
    ( 'UefaAssociationLeaguesScores', '10.28.216.45', 'UefaAssociationLeaguesScores_', 'UefaAssociationLeaguesScores', 'D', 'UEFA ASSOC LEAGUE SCORES'),
    ( 'ESPNSoccerSchedules',    '10.28.216.45', 'ESPNSoccerSchedules_',      'ESPNSoccerSchedules',       'D', 'ESPN SOCCER SCHEDULES'),
    ( 'ESPNGroupStandings',     '10.28.216.45', 'ESPNGroupStandings_',       'ESPNGroupStandings',        'D', 'ESPN GROUP STANDINGS'),
    ( 'EspnStandings',          '10.28.216.45', 'EspnStandings_',            'EspnStandings',             'D', 'ESPN SOCCER STANDINGS'),
    ( 'FIFAInternationalSchedules', '10.28.216.45', 'FIFAInternationalSchedules_',    'FIFAInternationalSchedules',   'D', 'FIFA INTERNATIONAL SCHEDULES'),
    ( 'FIFAInternationalScores',    '10.28.216.45', 'FIFAInternationalScores_',       'FIFAInternationalScores',      'D', 'FIFA INTERNATIONAL SCORES'),
    ( 'FIFATeamStandings',      '10.28.216.45', 'FIFATeamStandings_',        'FIFATeamStandings',         'D', 'FIFA TEAM STANDINGS'),
    ( 'FIFAStandings',          '10.28.216.45', 'FIFAStandings_',            'FIFAStandings',             'D', 'FIFA GROUP STANDINGS'),
    ( 'FIFAWorldCup',           '10.28.216.45', 'FIFAWorldCup_',             'FIFAWorldCup',              'D', 'FIFA WORLD CUP'),
    ( 'FIFAWorldCupQualifiers', '10.28.216.45', 'FIFAWorldCupQualifiers_',   'FIFAWorldCupQualifiers',    'D', 'FIFA WORLD CUP QUALIFIERS'),
    ( 'UEFAMajorLeaguesRoster', '10.28.216.45', 'UEFAMajorLeaguesRoster_',   'UEFAMajorLeaguesRoster',    'D', 'UEFA MAJOR LEAGUE ROSTER'),
    ( 'SoccerwaySoccerSchedules', '10.28.216.45', 'SoccerwaySoccerSchedules_', 'SoccerwaySoccerSchedules', 'D', 'SOCCERWAY SOCCER SCHEDULES'),
    ( 'SoccerwaySoccerScores', '10.28.216.45', 'SoccerwaySoccerScores_', 'SoccerwaySoccerScores', 'D', 'SOCCERWAY SOCCER SCORES'),
    ( 'SoccerwayInternationalSchedules', '10.28.216.45', 'SoccerwayInternationalSchedules_', 'SoccerwayInternationalSchedules', 'D', 'SOCCERWAY INTERNATIONAL SCHEDULES'),
    ( 'SoccerwayInternationalScores', '10.28.216.45', 'SoccerwayInternationalScores_', 'SoccerwayInternationalScores', 'D', 'SOCCERWAY INTERNATIONAL SCORES'),
    ( 'SoccerwayStandings',    '10.28.216.45', 'SoccerwayStandings_',        'SoccerwayStandings',        'D', 'SOCCERWAY SOCCER STANDINGS'),
    ( 'SoccerwayRoster',       '10.28.216.45', 'SoccerwayRoster_',           'SoccerwayRoster',           'D', 'SOCCERWAY SOCCER ROSTER'),
    ( 'SoccerwaySoccerFacupSchedules',  '10.28.216.45', 'SoccerwaySoccerFacupSchedules_', 'SoccerwaySoccerFacupSchedules', 'D', 'SOCCERWAY FACUP SCHEDULES'),
    ( 'SoccerwaySoccerFacupScores',     '10.28.216.45', 'SoccerwaySoccerFacupScores_',    'SoccerwaySoccerFacupScores',    'D', 'SOCCERWAY FACUP SCORES'),
    ( 'MLSStandings',          '10.28.216.45', 'MLSStandings_',              'MLSStandings',              'D', 'MLS SOCCER STANDINGS'),
    ( 'FIFAClubWorldCup',      '10.28.216.45', 'FIFAClubWorldCup_',          'FIFAClubWorldCup',          'D', 'FIFA CLUB WORLD CUP'),
    ( 'AFCAsianCup',            '10.28.216.45', 'AFCAsianCup_',              'AFCAsianCup',               'D', 'AFC ASIAN CUP'),
    ( 'AFCStandings',           '10.28.216.45', 'AFCStandings_',             'AFCStandings',              'D', 'AFC STANDINGS'),
    ( 'FIFAWomenStandings',     '10.28.216.45', 'FIFAWomenStandings_',       'FIFAWomenStandings',        'D', 'FIFA WOMENS STANDINGS'),
    ( 'CONCACAFSoccer',         '10.28.216.45', 'CONCACAFSoccer_',           'CONCACAFSoccer',            'D', 'CONCACAF SOCCER'),
    ( 'CCLStandings',           '10.28.216.45', 'CCLStandings_',             'CCLStandings',              'D', 'CCL STANDINGS'),
    ( 'CONCACAFU20',            '10.28.216.45', 'CONCACAFU20_',              'CONCACAFU20',               'D', 'CONCACAF U20'),
    ( 'CONCACAFU20Standings',   '10.28.216.45', 'CONCACAFU20Standings_',     'CONCACAFU20Standings',      'D', 'CONCACAF U20 STANDINGS'),
    ( 'MLSSoccerSchedules',     '10.28.216.45', 'MLSSoccerSchedules_',       'MLSSoccerSchedules',        'D', 'MLS SOCCER SCHEDULES'),
    ( 'MLSSoccerScores',        '10.28.216.45', 'MLSSoccerScores_',          'MLSSoccerScores',           'D', 'MLS SOCCER SCORES'),
    ( 'BallonAwards',           '10.28.216.45', 'BallonAwards_',             'BallonAwards',              'D', 'BALLON AWARDS'),
    ( 'CSLSoccerSchedules',     '10.28.216.45', 'CSLSoccerSchedules_',       'CSLSoccerSchedules',        'D', 'CSL SCHEDULES'),
    ( 'CSLSoccerScores',        '10.28.216.45', 'CSLSoccerScores_',          'CSLSoccerScores',           'D', 'CSL SCORES'),


    ( 'UfcSpiderSchedules',     '10.28.216.45', 'UfcSpiderSchedules_',       'UfcSpiderSchedules',        'D', 'UFC SPIDER SCHEDULES'),
    ( 'UfcSpiderScores',        '10.28.216.45', 'UfcSpiderScores_',          'UfcSpiderScores',           'D', 'UFC SPIDER SCORES'),

    ( 'WBABoxingSpiderSchedules', '10.28.216.45', 'WBABoxingSpiderSchedules_', 'WBABoxingSpiderSchedules', 'D', 'WBA BOXING SPIDER SCHEDULES'),
    ( 'WBABoxingSpiderScores',  '10.28.216.45',   'WBABoxingSpiderScores_',   'WBABoxingSpiderScores',     'D', 'WBA BOXING SPIDER SCORES'),

    ( 'NCAASpiderScores',       '10.28.216.45', 'NCAASpiderScores_',         'NCAASpiderScores',          'D', 'NCAA SPIDER SCORES'),
    ( 'NCAASpiderSchedules',    '10.28.216.45', 'NCAASpiderSchedules_',      'NCAASpiderSchedules',       'D', 'NCAA SPIDER SCHEDULES'),
    ( 'NcfSpiderScores',        '10.28.216.45', 'NcfSpiderScores_',          'NcfSpiderScores',           'D', 'NCF SPIDER SCORES'),
    ( 'NcfSpiderSchedules',     '10.28.216.45', 'NcfSpiderSchedules_',       'NcfSpiderSchedules',        'D', 'NCF SPIDER SCHEDULES'),
    ( 'NCAAFootballScores',     '10.28.216.45', 'NCAAFootballScores_',       'NCAAFootballScores',        'D', 'NCAA FOOTBALL SCORES'),
    ( 'NCAAFootballSchedules',  '10.28.216.45', 'NCAAFootballSchedules_',    'NCAAFootballSchedules',     'D', 'NCAA FOOTBALL SCHEDULES'),
    ( 'NCBRoster',              '10.28.216.45', 'NCBRoster_',                'NCBRoster',                 'D', 'NCB ROSTER'),
    ( 'NCBStandings',           '10.28.216.45', 'NCBStandings_',             'NCBStandings',              'D', 'NCB STANDINGS'),
    ( 'NCAANCFStandings',       '10.28.216.45', 'NCAANCFStandings_',         'NCAANCFStandings',          'D', 'NCAA NCF STANDINGS'),
    ( 'NCFTouStandings',        '10.28.216.45', 'NCFTouStandings_',          'NCFTouStandings',           'D', 'NCF TOU STANDINGS'),

    ( 'RugbySpiderScores',      '10.28.216.45', 'RugbySpiderScores_',        'RugbySpiderScores',         'D', 'RUGBY SPIDER SCORES'),
    ( 'RugbySpiderSchedules',   '10.28.216.45', 'RugbySpiderSchedules_',     'RugbySpiderSchedules',      'D', 'RUGBY SPIDER SCHEDULES'),
    ( 'RugbyStandings',         '10.28.216.45', 'RugbyStandings_',           'RugbyStandings',            'D', 'RUGBY SIXNATIONS STANDINGS'),
    ( 'NRLRugby',               '10.28.216.45', 'NRLRugby_',                 'NRLRugby',                  'D', 'NRL RUGBY'),
    ( 'EuropeRugbyStandings',   '10.28.216.45', 'EuropeRugbyStandings_',     'EuropeRugbyStandings',      'D', 'EUROPE RUGBY STANDINGS'),
    ( 'RugbyEuropeSpiderSchedules', '10.28.216.45', 'RugbyEuropeSpiderSchedules_', 'RugbyEuropeSpiderSchedules', 'D', 'RUGBY EUROPE SPIDER SCHEDULES'),
    ( 'RugbyEuropeSpiderScores', '10.28.216.45', 'RugbyEuropeSpiderScores_', 'RugbyEuropeSpiderScores', 'D', 'RUGBY EUROPE SPIDER SCORES'),
    ( 'RFUChampionsSchedules',   '10.28.216.45', 'RFUChampionsSchedules_',   'RFUChampionsSchedules',     'D', 'RUGBY CHAMPIONS SCHEDULES'),
    ( 'RFUChampionsScores',      '10.28.216.45', 'RFUChampionsScores_',      'RFUChampionsScores',        'D', 'RUGBY CHAMPIONS SCORES'),
    ( 'RFUChampionsStandings',   '10.28.216.45', 'RFUChampionsStandings_',   'RFUChampionsStandings',     'D', 'RUGBY CHAMPIONS STANDINGS'),
    ( 'SuperRugbyStandings',     '10.28.216.45', 'SuperRugbyStandings_',     'SuperRugbyStandings',       'D', 'SUPER RUGBY STANDINGS'),
    ( 'SuperRugbySpiderScores',  '10.28.216.45', 'SuperRugbySpiderScores_',  'SuperRugbySpiderScores',    'D', 'SUPER RUGBY SPIDER SCORES'),
    ( 'SuperRugbySpiderSchedules', '10.28.216.45', 'SuperRugbySpiderSchedules_', 'SuperRugbySpiderSchedules', 'D', 'SUPER RUGBY SPIDER SCHEDULES'),
    ( 'ITMCupRugbySpider',      '10.28.216.45',  'ITMCupRugbySpider_',       'ITMCupRugbySpider',         'D', 'ITM CUP RUGBY SPIDER'),
    ( 'ITMCupRugbyStandings',   '10.28.216.45',  'ITMCupRugbyStandings_',    'ITMCupRugbyStandings',      'D', 'ITM CUP RUGBY STANDINGS'),
    ( 'HeartlandRugby',         '10.28.216.45',  'HeartlandRugby_',          'HeartlandRugby',            'D', 'HEARTLAND RUGBY'),
    ( 'SuperLeagueRugbyScores',  '10.28.216.45',  'SuperLeagueRugbyScores_',  'SuperLeagueRugbyScores',     'D', 'SUPER LEAGUE RUGBY SCORES'),
    ( 'SuperLeagueRugbySchedules', '10.28.216.45', 'SuperLeagueRugbySchedules_', 'SuperLeagueRugbySchedules', 'D', 'SUPER LEAGUE RUGBY SCHEDULES'),
    ( 'SuperLeagueStandings',    '10.28.216.45',  'SuperLeagueStandings_',   'SuperLeagueStandings',      'D',  'SUPER LEAGUE STANDINGS'),
    ( 'SuperRugbyRoster',        '10.28.216.45',  'SuperRugbyRoster_',       'SuperRugbyRoster',          'D', 'SUPER RUGBY ROSTER'),
    ( 'HeartlandStandings',      '10.28.216.45',  'HeartlandStandings_',     'HeartlandStandings',        'D', 'HEARTLAND STANDINGS'),
    ( 'RugbyWorldCupRoster',     '10.28.216.45',  'RugbyWorldCupRoster_',    'RugbyWorldCupRoster',        'D', 'RUGBY WORLD CUP ROSTER'),
    ( 'RugbyWorldCup',           '10.28.216.45',  'RugbyWorldCup_',          'RugbyWorldCup',              'D', 'RUGBY WORLD CUP'),
    ( 'RugbyWorldCupStandings',  '10.28.216.45',  'RugbyWorldCupStandings_', 'RugbyWorldCupStandings',     'D', 'RUGBY WORLD CUP STANDINGS'),
    ( 'RugbyChampStandings',     '10.28.216.45',  'RugbyChampStandings_',    'RugbyChampStandings',        'D', 'RUGBY CHAMP STANDINGS'),

    ( 'MotogpSpider',           '10.28.216.45', 'MotogpSpider_',             'MotogpSpider',              'D', 'MOTOGP SPIDER'),
    ( 'MotoStandings',          '10.28.216.45', 'MotoStandings_',            'MotoStandings',             'D', 'MOTO STANDINGS'),
    ( 'RacingStandings',        '10.28.216.45', 'RacingStandings_',          'RacingStandings',           'D', 'AUTO RACING STANDINGS'),
    ( 'NascarStandings',        '10.28.216.45', 'NascarStandings_',          'NascarStandings',           'D', 'NASCAR STANDINGS'),
    ( 'F1Standings',            '10.28.216.45', 'F1Standings_',              'F1Standings',               'D', 'F1 STANDINGS'),
    ( 'F1Winner',               '10.28.216.45', 'F1Winner_',                 'F1Winner',                  'D', 'F1 WINNER'),

    ( 'MarathonStandings',      '10.28.216.45', 'MarathonStandings_',        'MarathonStandings',         'D', 'MARATHON STANDINGS'),

    ( 'WACMedals',              '10.28.216.45', 'WACMedals_',                'WACMedals',                 'D', 'WAC STANDINGS'),
    ( 'WCAMedals',              '10.28.216.45', 'WCAMedals_',                'WCAMedals',                 'D', 'WCA STANDINGS'),

    ( 'UCIWorldTour',           '10.28.216.45', 'UCIWorldTour_',             'UCIWorldTour',              'D', 'UCI CYCLING WORLD TOUR'),
    ( 'CyclingStandings',       '10.28.216.45', 'CyclingStandings_',         'CyclingStandings',          'D', 'CYCLING STANDINGS'),
    ( 'LetourGames',            '10.28.216.45', 'LetourGames_',              'LetourGames',               'D', 'LETOUR GAMES'),
    ( 'LetourStandings',        '10.28.216.45', 'LetourStandings_',          'LetourStandings',           'D', 'LETOUR STANDINGS'),
    ( 'LetourGroupStandings',   '10.28.216.45', 'LetourGroupStandings_',     'LetourGroupStandings',      'D', 'LETOUR GROUPSTANDINGS'),
    ( 'UCIWomensStandings',     '10.28.216.45', 'UCIWomensStandings_',       'UCIWomensStandings',        'D',  'UCI WOMENS STANDINGS'),
    ( 'UCIWomensWorldcupScores', '10.28.216.45', 'UCIWomensWorldcupScores_', 'UCIWomensWorldcupScores',   'D',  'UCI WOMENS WORLDCUP SCORES'),
    ( 'UCIWomensWorldcupSchedules', '10.28.216.45', 'UCIWomensWorldcupSchedules_', 'UCIWomensWorldcupSchedules', 'D', 'UCI WOMENS WORLDCUP SCHEDULES'),
    ( 'UCIWomensTour',         '10.28.216.45',   'UCIWomensTour_',           'UCIWomensTour',            'D',  'UCI WOMENS TOUR'),

    ( 'ChessRapidScores',       '10.28.216.45', 'ChessRapidScores_',         'ChessRapidScores',          'D', 'CHESS RAPID GAMES'),
    ( 'ChessBlitzScores',       '10.28.216.45', 'ChessBlitzScores_',         'ChessBlitzScores',          'D', 'CHESS BLITZ GAMES'),
    ( 'RapidBlitzStandings',    '10.28.216.45', 'RapidBlitzStandings_',      'RapidBlitzStandings',       'D', 'RAPID & BLITZ STANDINGS'),
    ( 'WorldRapidBlitzStandings',   '10.28.216.45', 'WorldRapidBlitzStandings_',      'WorldRapidBlitzStandings',     'D', 'WORLD RAPID & BLITZ STANDINGS'),
    ( 'WorldChess',             '10.28.216.45', 'WorldChess_',               'WorldChess',                'D', 'WORLD CHESS SPIDER'),
    ( 'ChessGrandPrix',         '10.28.216.45', 'ChessGrandPrix_',           'ChessGrandPrix',            'D', 'CHESS FIDE GRAND PRIX'),

    ( 'FieldHockeyRoster',      '10.28.216.45', 'FieldHockeyRoster_',        'FieldHockeyRoster',         'D', 'FIELD HOCKEY ROSTER'),
    ( 'FieldHockeySchedules',   '10.28.216.45', 'FieldHockeySchedules_',     'FieldHockeySchedules',      'D', 'FIELD HOCKEY SCHEDULES'),
    ( 'FieldHockeyScores',      '10.28.216.45', 'FieldHockeyScores_',        'FieldHockeyScores',         'D', 'FIELD HOCKEY SCORES'),

    ( 'CommonWealthGames',      '10.28.216.45', 'CommonWealthGames_',        'CommonWealthGames',         'D', 'COMMONWEALTH GAMES'),
    ( 'CWStandings',            '10.28.216.45', 'CWStandings_',              'CWStandings',               'D', 'COMMONWEALTH STANDINGS'),
    ( 'CommonWealthTeamGames',  '10.28.216.45', 'CommonWealthTeamGames_',    'CommonWealthTeamGames',     'D', 'COMMONWEALTH TEAM GAMES'),
    ( 'CommonWealthHockeyGames', '10.28.216.45', 'CommonWealthHockeyGames_',  'CommonWealthHockeyGames',   'D', 'COMMONWEALTH HOCKEY GAMES'),
    ( 'CricketRoster',          '10.28.216.45', 'CricketRoster_',             'CricketRoster',              'D', 'CRICKET ROSTER'),
    ( 'FIBASpider',             '10.28.216.45', 'FIBASpider_',                'FIBASpider',                 'D',  'FIBA SPIDER'),
    ( 'CollegeWorldSeries',     '10.28.216.45', 'CollegeWorldSeries_',        'CollegeWorldSeries',         'D',  'COLLEGE WORLD SERIES SCHEDULES'),
    ( 'NCFRoster',              '10.28.216.45', 'NCFRoster_',                 'NCFRoster',                 'D',  'NCF ROSTER'),
    ( 'SuperLeague',            '10.28.216.45', 'SuperLeague_',               'SuperLeague',               'D',  'INDIAN SUPER LEAGUE'),
    ( 'NCAABowl',               '10.28.216.45', 'NCAABowl_',                  'NCAABowl',                  'D',  'NCAA BOWL GAMES'),
    ( 'MLBMVPSpider',           '10.28.216.45', 'MLBMVPSpider_',              'MLBMVPSpider',              'D',  'MLB MVP'),
    ( 'ISLStandings',           '10.28.216.45', 'ISLStandings_',              'ISLStandings',              'D',  'ISL STANDINGS'),
    ( 'RacingGames',            '10.28.216.45', 'RacingGames_',               'RacingGames',               'D',  'AUTO RACING GAMES'),
    ( 'UEFAGroupStandings',     '10.28.216.45', 'UEFAGroupStandings_',        'UEFAGroupStandings',        'D',  'UEFA GROUP STANDINGS'),

    ( 'EOCWaterPolo',           '10.28.216.45', 'EOCWaterPolo_',              'EOCWaterPolo',              'D',  'EOC WATER POLO'),
]
...
class Report(VtvTask):
    ...
    def create_report_file(self, date_yesterday, BIG_LIST, table_list):
        ...
        today_file_name = os.path.join(self.REPORTS_DIR, '%s_report_%s.html' % (self.script_prefix, 'latest'))
    ...
    def run_main(self):
        '''for rec in STATS_DIR_LIST:
            source, ip, prefix, report_dir, date_format, title = rec
            print '[%s]\nSERVER_NAME=%s\nSERVER_IP=%s\nFREQUENCY=DAILY\nREPORT_PREFIX=%s\nREMOTE_DIR=%s\nTITLE=%s\nSTATS_FUNC_NAME=%s\n' %(report_dir, title.split( )[0], ip, prefix, report_dir, title, 'get_spider_stats')
        '''
