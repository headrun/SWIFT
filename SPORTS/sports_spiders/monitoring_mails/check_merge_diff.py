...
################################################################################
#$Id: check_merge_diff.py,v 1.1 2015/12/14 11:10:57 headrun Exp $
################################################################################
...
def check_dir(path=DATAGEN_DIR):
    if not os.path.isdir(DATAGEN_DIR):
        os.mkdir(DATAGEN_DIR)
...
class DatagenFailures:
    ...
    def __init__(self):
        ...
        self.conn           = MySQLdb.connect(user="veveo", passwd="veveo123", db="SPORTSDB", host="10.28.218.81")
    ...
    def get_failure_cases(self):
        ...
        for data in open(datagen_file):
            if TE_PATTERN in data:
                ...
                te_failures.append([team_title, player_title, needed_titles, suite_name + ': ' + test_id])
            ...
            if TO_PATTERN in data:
                ...
                to_failures.append([team_title, player_title, needed_titles, suite_name + ': ' + test_id])
