...
class DatagenFailures:
    ...
    def send_mail(self, text):
        ...
        receivers.extend(['Raman.Arunachalam@tivo.com', 'Dheeraj.Mukka@tivo.com', 'Gurdeep.Mittal@tivo.com', 'Jagadeswar.Mettupalli@tivo.com', 'Binitha.Sobha@tivo.com', 'swathi@headrun.com', 'Vinay.Kumar@tivo.com', 'VenkataBabji.Perambattu@tivo.com','Ranjan.Goyal@tivo.com'])
    ...
    def get_failure_cases(self):
        ...
        for data in open(datagen_file):
                ...
                #continue
            if ('"ERROR", "msg": "GROUP: SEED ID: ' not in data) and ('"ERROR", "msg": "GROUP: SPORTS ID: ' not in data) and  ('"ERROR", "msg": "GROUP: CONTENT: ' not in data) :
                continue
