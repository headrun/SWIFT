...
################################################################################
#$Id: generate_datagen_failures.py,v 1.1 2017/12/28 10:37:24 headrun Exp $
################################################################################
...
class DatagenFailures:
    ...
    def send_mail(self, text):
        ...
        receivers.extend(['Raman.Arunachalam@tivo.com', 'Dheeraj.Mukka@tivo.com', 'Gurdeep.Mittal@tivo.com', 'Jagadeswar.Mettupalli@tivo.com', 'Binitha.Sobha@tivo.com', 'yuvarani@headrun.com', 'swathi@headrun.net', 'Vinay.Kumar@tivo.com'])
