...
def main():
    ...
    query  = "select tournament_id, event_id from sports_tournaments_events where tournament_id in (select id from sports_tournaments where game ='motorcycle racing' and type='tournament')"
