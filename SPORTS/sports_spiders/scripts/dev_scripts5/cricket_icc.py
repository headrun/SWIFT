...
skipped_matches = ['730587', '730589', '730081', '756031', '756033', '754715', '760779', '779097', '754733', '754735', '722327', '810279', '754745', '766925', '766927', '743933', '743935', '810421', '804705', '903583', '905783', '905785', '905787', '902631', '902633']
cancelled_matches = ['770131', '780257', '770133', '770135', '770137', '754733', '722327', '810279', '766925', '766927', '829755', '743933', '743935', '810421', '743937', '804545', '902631', '902633']
tbd_ids = ['3600', '3760']


class IccCricket(VTVSpider):
    '''Class function
    '''
    name            = "cricket_icc"
    ...
    def get_team_name(self, team):
        teams_tuple = ("india", "west indies", "sri lanka", "australia", "pakistan", "zimbambwe", "new zealand", \
                      "england", "south africa", "bangladesh", "canada", "scotland", "netherlands", "ireland", 'oman', \
                      "kenya", "bermuda", "tba", "hong kong", "papua new guinea", "namibia", "united arab emirates")
        for tm in teams_tuple:
            if team == "West Indians":
                tm = "west indies"
                team = "West Indies"
            if team == "Sri Lanka Board President's XI":
                tm = "sri lanka board"
            if team == "Indian Board President's XI":
                tm = "indian board"
    ...
    def data_replacement(self, data):
        ...
        replace_dict = {'Sri Lankans': 'Sri Lanka', 'Indians': 'India', 'home': '', '\n': '', \
                        ...
                        "Indian Board President's XI": "Indian Board President's XI", \
                        "SL Pres. XI": "SL BP XI", 'Bangladesh Cricket Board XI': 'BCB XI', \
                        'Sunrisers Hyderabad' : 'Sunrisers', 'Rajasthan Royals': 'Royals', 'Mumbai India': \
                        'Mum India', 'Brisbane Heat' : 'Heat',
                        ...
                        'Gloucestershire' : 'Gloucs', 'Nottinghamshire' : 'Notts', \
                        'Southern Express' :'Express',
                        'Northern Districts' : 'Northern D', 'Kolkata Knight Riders' : 'KKR', \
                        "St Kittsevis": "St Kitts & N",
                        'Hobart Hurricanes' : 'Hurricanes', 'Kings XI Punjab' : 'Kings', \
                        'Barbados Tridents' : 'Tridents', \
                        'Cricket Australia': '', 'Pakistan A': '', \
                        'Guyana Amazon Warriors': 'Warriors', \
                        'Cricket Australia XI': '', "New Zealand Chairman's" : 'N Zealanders', \
                        'Delhi Daredevils': 'Daredevils', 'Royal Challengers Bangalore': 'RCB', \
                        'Guyana Amazon Warriors' : 'Amazon', 'St Lucia Zouks' : 'Zouks', \
                        'Trinidad & Tobago Red Steel': 'Red Steel', \
                        'Jamaica Tallawahs' : 'Tallawahs', 'Papua New Guinea' : 'P.N.G.', \
                        'St Kitts and Nevis Patriots':  'Patriots', \
                        'Diasqua Little Sai Wan Cricket Club': 'Diasqua', \
                        'Hong Kong Cricket Club': 'Hong Kong CC', \
                        'Kowloon Cricket Club': 'Kowloon CC', \
                        'Hong Kong Cricket Association Under-19s': 'HKCA U-19', \
                        'Pakistan Association of Hong Kong': 'Pakistan AHG', \
                        'ssociation of Hong Kong': 'HG', \
                        'Pakistan HKG': 'Pakistan AHG', 'Western Australia': 'West Aust', \
                        'South Australia': 'South Aust', 'New South Wales': 'NSW', \
                        "Sri Lanka Board President's XI": 'SL Pres. XI'}
    ...
    def get_tournament(self, data):
        ...
        '''
        tou_dict = {"test" : "Test cricket", "t20i" : "Twenty20", \
                    "asia-cup" : "Asia Cup", "world-t20" : "Icc World Twenty20", "west indies tri" :\
                    "One Day International", "icc champions trophy" : "ICC Champions Trophy", "test series" :\
                    "Test cricket", "odi" : "One Day International", "natwest series" :\
                    "odi cricket", "rsa challenge" : "One Day International", "the ashes" : "Test cricket", \
                    "champions league twenty20" : "Twenty20", "pataudi trophy" : "Test cricket", \
                    "icc intercontinental" : "One Day International", "icc world cricket league" : "One Day International", \
                    ...
                    'natwest t20 blast' : 'Twenty20', 'zimbabwe triangular series' : 'One Day International', \
                    'dubai triangular series': 'One Day International', 'wcl-championship': 'ICC World Cricket League Championship',  \
                    'icc-intercontinental-cup': 'ICC Intercontinental Cup', 'icc intercontinental cup': 'ICC Intercontinental Cup', \
                    'lv= county championship division one' : "County cricket", \
                    "lv= county championship division two": "County cricket", \
                    "natwest t20 blast ": "County cricket", 'royal london one-day cup': "County cricket", \
                    'big-bash-league': "Big Bash League", 'hong-kong-premier-league' : "Hong Kong Premier League"}
    ...
    def parse(self, response):
        ...
        if not self.status:
            self.status         = True
            cricket_tournaments = [ 
                                    'http://www.espncricinfo.com/caribbean-premier-league-2015/engine/series/846823.html', \
                                    'http://www.espncricinfo.com/bangladesh-v-india-2015/engine/series/870723.html',  \
                                    ...
                                    'http://www.espncricinfo.com/ci/engine/series/895859.html',
                                    'http://www.espncricinfo.com/sri-lanka-v-india-2015/engine/series/895769.html', \
                                    'http://www.espncricinfo.com/australia-v-india-2015-16/engine/series/895801.html', \
                                    'http://www.espncricinfo.com/sri-lanka-v-india-2015/engine/series/895057.html', \
                                    'http://www.espncricinfo.com/australia-v-new-zealand-2015-16/engine/series/892499.html', \
                                    'http://www.espncricinfo.com/australia-v-west-indies-2015-16/engine/series/892505.html', \
                                    'http://www.espncricinfo.com/india-v-south-africa-2015-16/engine/series/903573.html', \
                                    'http://www.espncricinfo.com/pakistan-v-england-2015-16/engine/series/902607.html', \
                                    'http://www.espncricinfo.com/bangladesh-v-australia-2015-16/engine/series/905725.html', \
                                    'http://www.espncricinfo.com/sri-lanka-v-west-indies-2015-16/engine/series/915221.html', \
                                    'http://www.espncricinfo.com/hong-kong-premier-league-od-2015-16/engine/series/918639.html', \
                                    'http://www.espncricinfo.com/sheffield-shield-2015-16/engine/series/895859.html', \
                                    'http://www.espncricinfo.com/big-bash-league-2015-16/engine/series/897689.html'
                                    ]
            cricket_tournaments = ['http://www.espncricinfo.com/icc-world-twenty20-2016/engine/series/901359.html']

            for tournaments in cricket_tournaments:
                yield Request(tournaments, callback=self.parse_second)

        nodes = get_nodes(hxs, '//div[contains(@class, "tab-content")]//ul')
        for node in nodes:
            tours = extract_data(node, './/preceding-sibling::h2//text()')

            if tours not in ('International Tours'):
                continue

            reference_urls  = get_nodes(node, './/li//a//@href')
            for reference in reference_urls:
                ...
                if not "http" in reference:
                    ...
                    reference = "http://www.espncricinfo.com/icc-world-twenty20-2016/engine/series/901359.html"
    ...
    def parse_second(self, response):
        ...
        for node in nodes:
            ...
            if "champions-league-twenty20" in response.url:
                ...
                affiliation = 'ipl'
            elif "caribbean-premier-league" in response.url:
                affiliation = 'cpl'
            elif "hong-kong-premier-league" in response.url:
                affiliation = 'hkpl'
            else:
                affiliation = 'icc'
            ...
            if len(tou) < 2:
                ...
                if "asia-cup" in response.url:
                    ...
                    tou = "Caribbean Premier League"
                elif "hong-kong-premier-league" in response.url:
                    tou = "Hong Kong Premier League"
                    ...
                    tou = "County cricket"
                elif "big-bash-league" in response.url:
                    tou = "Big Bash League"
            ...
            if match_link and game_time:
                ...
                if "royal-london-one-day-cup" in response.url:
                    tou = "County cricket"
                if "big-bash-league" in response.url:
                    tou = "Big Bash League"
                ...
                yield Request(match_link, callback = self.parse_schedules, \
                              meta = {'rich_data' : rich_data, 'record' : record, \
                              'games_dict' : self.games_dict, \
                              'winners_file' : self.winners_file, 'dt' : _dt, \
                              'file_existance' : self.file_existance, \
                              'match_title': match_title, 'time_unknown': time_unknown, \
                              'affiliation': affiliation, 'ref': match_link, 'tou': tou, \
                              'tou_link': tou_link, 'series_name': series_name, \
                ...
                yield Request(match_link, callback=self.parse_schedule_details, \
                            ...
                            'series_name': series_name, 'season_start': season_start, \
                            'season_end': season_end})     #Passing game_date match link to schedule_details
    @log
    def parse_schedule_details(self, response):
        ...
        if "tour" in series_name and "hong kong" not in series_name:
        ...
        if source_key in skipped_matches:
            return
    ...
    def parse_schedules(self, response):
        ...
        if not teams:
            tnames   = [self.data_replacement(i) for i in \
            extract_list_data(hxs, '//div[@class="large-13 medium-13 columns innings-information"]//a[contains(@href, "/content/team/")]//text()')]
            teams   = extract_list_data(hxs, '//div[@class="large-13 medium-13 columns innings-information"]//a[contains(@href, "/content/team/")]//@href')
        ...
        if "Hong Kong Premier League" in tou_name:
            tou_name = "Hong Kong Premier League"
        team1 = team2 = ''
        if not tou_name:
            ...
            if not tou_name:
                ...
                elif "Caribbean Premier League" in tou_name:
                    tou_name = "Caribbean Premier League"
                elif "Hong Kong Premier League" in tou_name:
                    tou_name = "Hong Kong Premier League" 
        ...
        if "T20I" in response.meta['match_title']:
            tou_name = "T20I"

        if "ODI" in response.meta['match_title']:
            tou_name = "ODI"
        ...
        if not event_name:
            ...
            if "-Final" in response.meta['match_title']:
                event_name  = tournament + ' ' + event.replace('-', '') + 's'

            elif "Final" in response.meta['match_title']:
                event_name   = tournament + ' ' + "".join(re.findall(r'(.*):', response.meta['match_title']))
        ...
        if "tour" in series_name.lower() and "Hong Kong" not in series_name:
            country  = series_name.split(' tour of ')[-1].replace(' and ', "<>")
        ...
        if status_text.lower() in skipped_status or "match tied" in status_text.lower():
            winner = ''
        if _id == "829807" and winner == "628333":
            winner = "335970"
    ...
    def parse_location(self, response):
        ...
        tz_info = tz_info.split(',')[-1].split('UTC')[-1].split('00)')[0].strip().replace('1030', '10:30').replace(')', '').replace('0530', '05:30').replace('0100', '01').replace('0930', '09:30')
        ...
        if "Wanderers" in stadium:
            stadium = "Wanderers Cricket Ground"

        if "Rajiv Gandhi International Stadium" in stadium:
            stadium = "Rajiv Gandhi International Cricket Stadium"

        if "W.A.C.A. Ground" in stadium:
            stadium = "WACA Ground"

        if "International Sports Stadium" in stadium:
            stadium = "Coffs Harbour International Stadium"

        record['tz_info'] = tz_info
        rich_data['stadium'] =  stadium
        rich_data['game_note'] = game_note
        rich_data['location'] = {'city': city.replace(',', ''), 'country': country.replace(',', '')}
        import pdb;pdb.set_trace()
        yield record
