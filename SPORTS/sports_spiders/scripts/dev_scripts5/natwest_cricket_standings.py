...
class NatWestCricketStandings(VTVSpider):
    name = 'natwest_standings'
    allowed_domains = ["www.espncricinfo.com"]
    start_urls =  ["http://www.espncricinfo.com/natwest-t20-blast-2015/engine/series/803393.html?view=pointstable"]
    ...
    def parse(self, response):
        ...
        group_nodes = get_nodes(sel, '//div[@role="main"]//table')
        ...
        for group_node in group_nodes:
            ...
            for node in st_nodes[:10]:
                ...
                group_name = "NatWest t20 Blast " + group_name
