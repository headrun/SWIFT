...
class MLBCYSpider(VTVSpider):
    name = "cy_awards"
    start_urls = []

    def start_requests(self):
        urls = ['http://m.mlb.com/awards/history-winners/?award_id=NLCY',
                'http://m.mlb.com/awards/history-winners/?award_id=ALCY']
        for url in urls:
    ...
    def parse(self, response):
        ...
        for pl_node in pl_nodes[:1]:
            ...
            award_cat = league + " Cy Young Award"
            award_title = "Cy Young Award"
            venue = "USA"
            season = year
            result_type = "winner"
            game = "baseball"
