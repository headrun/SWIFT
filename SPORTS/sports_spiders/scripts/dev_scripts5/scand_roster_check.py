...
class SoccerWAYRostersDen(VTVSpider):
    name = "check_soccerway_den"
    ...
    country_list = ['Norway', 'Sweden', 'Finland', 'Iceland', 'Denmark']
    ...
    def __init__(self):
        ...
        #self.html_file = open('/home/veveo/reports/Scandinavia_Soccer_Leagues_Rosters_Stats_%s.html' % self.today, 'w')

    def send_mail(self, text):
        subject    = 'Scandinavia Soccer League Rosters'
        server     = '10.4.1.112'
        server = 'localhost'
