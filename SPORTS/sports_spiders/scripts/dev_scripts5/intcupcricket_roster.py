...
class ICCInterCupRosters(VTVSpider):
    name ="iccintcup_rosters"
    allowed_domains = []
    start_urls = ['http://www.espncricinfo.com/icc-intercontinental-cup-2015-17/content/squad?object=870857']
    participants = {}
