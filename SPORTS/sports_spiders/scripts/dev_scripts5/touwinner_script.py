...
def main():
    ...
    query  = "select tournament_id, final_event_id from sports_tournaments_finals where final_event_id in (select id from sports_tournaments where title like '% final%' and game not in ('tennis', 'hockey', 'basketball', 'soccer'))"
