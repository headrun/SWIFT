...
class Types:
    ...
    def __init__(self):
        self.conn = MySQLdb.connect(db='SPORTSDB_BKP', host='10.4.2.197', user='root')
    ...
    def main(self):
        ...
        for table in ['games', 'participants', 'tournaments']:
            ...
            for row in rows:
                ...
                if type_id:
                    query = 'update sports_%s set type_id="%s" where game="%s"'
