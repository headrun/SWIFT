...
def main():
    ...
    for event in data:
		...
		cursor.execute(TOU_RESULTS %('1', 'winner', winner_group.lower(), result_value[0][0], winner_group.lower(), 'winner'))
                cursor.execute(TOU_RESULTS %('1', 'winner2', winner_group.lower(), result_value[1][0], winner_group.lower(), 'winner2'))
