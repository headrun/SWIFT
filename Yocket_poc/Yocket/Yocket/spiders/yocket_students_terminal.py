...
class YocketTerminal(GenSpider):
    ...
    def parse(self, response):
        ...
        profile_name = extract_data(
            sel, '//div[@class="col-sm-12"]//h1//strong/text()').strip() or sk.strip()
        university = extract_data(
            sel, '//div[@class="col-sm-12 university-header"]//h1/text()')
        ...
        for applied_university_node in applied_universities_nodes:
            ...
            csv_item.update({
                ...
                "Appliedcourse": applied_course, "TOEFLSCORE": course_tests_dict.get("TOEFL", {}).get("total_value", ""),
