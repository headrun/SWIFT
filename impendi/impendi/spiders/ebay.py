...
conn = MySQLdb.connect(host='localhost', user='root', passwd= 'P@tN3R#74#$', db="urlqueue", charset='utf8mb4', use_unicode=True)
cursor = conn.cursor()
cursor.execute('select sk, search_key, end_time from ebay_crawl')
